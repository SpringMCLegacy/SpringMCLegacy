...
local Sounds = {
	SoundItems = {
		...
		Whir_Small = {
			file = "sounds/outpost/Whir_Small.wav",
			maxconcurrent = 12,
			gainmod = 0.75,
			pitchmod = 0.1,
			priority = -0.1,
		...
		Clicks = {
			file = "sounds/outpost/Clicks.wav",
			maxconcurrent = 12,
			gainmod = 0.75,
			pitchmod = 0.1,
			priority = -0.1,
		...
		Breech_Open = {
			file = "sounds/outpost/Breech_Open.wav",
			maxconcurrent = 12,
			gainmod = 0.75,
			pitchmod = 0.1,
			priority = -0.1,
		...
		Breech_Close = {
			file = "sounds/outpost/Breech_Close.wav",
			maxconcurrent = 12,
			gainmod = 0.75,
			pitchmod = 0.1,
			priority = -0.1,
