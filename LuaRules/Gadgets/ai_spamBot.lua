...
local desired = {"CMD_SEND_ORDER", "CMD_DROPZONE", -- mech purchasing
				...
				"CMD_OUTPOST_VEHICLEPAD", "CMD_OUTPOST_EWAR", "CMD_OUTPOST_GARRISON", "CMD_OUTPOST_ARTILLERY", --"CMD_OUTPOST_SALVAGEYARD", 
...
local function Outpost(beaconID, teamID)
	beaconID = beaconID or GG.dropZoneBeaconIDs[teamID]
