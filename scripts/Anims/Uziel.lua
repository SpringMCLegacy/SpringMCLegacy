...
--	Spring.Echo("anim_StartJump")
		...
		Turn(rbacktoes, x_axis, rad(-15), LEG_SPEED * speedMod* 4)
		...
		Turn(lbacktoes, x_axis, rad(-15), LEG_SPEED * speedMod* 4)
...
--	Spring.Echo("anim_StopJump")
		...
		Turn(rbacktoes, x_axis, rad(0), LEG_SPEED * speedMod* 4)
		...
		Turn(lbacktoes, x_axis, rad(0), LEG_SPEED * speedMod* 4)
...
--		Spring.Echo("anim_Walk")
		...
		Turn(lupperleg, x_axis, rad(5), LEG_SPEED * speedMod* 2)
		...
		Turn(rupperleg, x_axis, rad(5), LEG_SPEED * speedMod* 2)
