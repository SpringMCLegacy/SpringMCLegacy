...
--		Spring.Echo("anim_Turn")
		--Left Leg Up...
		Turn(pelvis, z_axis, rad(2.5), LEG_TURN_SPEED / 2)
...
--	Spring.Echo("anim_PreJump")
	anim_Reset()
		...
		Turn(rlowerleg, x_axis, rad(60), LEG_SPEED * 2)
		Turn(lupperleg, x_axis, rad(-30), LEG_SPEED)
		Turn(llowerleg, x_axis, rad(60), LEG_SPEED * 2)
		Move(pelvis, y_axis, -4, LEG_SPEED * 8)
...
--	Spring.Echo("anim_StartJump")
		...
		Turn(rupperarm, x_axis, rad(20), LEG_SPEED * 4)
		Turn(lupperarm, x_axis, rad(20), LEG_SPEED * 4)
...
--	Spring.Echo("anim_StopJump")
		--Touchdown!
		Turn(rupperleg, x_axis, rad(-30), LEG_SPEED * 4)
		Turn(rlowerleg, x_axis, rad(35), LEG_SPEED * 4)
		Turn(rfoot, x_axis, rad(5), LEG_SPEED * 4)
		Turn(lupperleg, x_axis, rad(-30), LEG_SPEED * 4)
		Turn(llowerleg, x_axis, rad(35), LEG_SPEED * 4)
		Turn(lfoot, x_axis, rad(5), LEG_SPEED * 4)
		Move(pelvis, y_axis, -4, LEG_SPEED * 18)
...
--		Spring.Echo("anim_Walk")
		...
		Turn(rupperleg, x_axis, rad(-45), LEG_SPEED / 1.5)
		Turn(rlowerleg, x_axis, rad(45), LEG_SPEED)
		Turn(lupperleg, x_axis, rad(20), LEG_SPEED / 1.5)
		...
		-- STEP 3
		Turn(pelvis, z_axis, rad(-2), LEG_SPEED)
		Turn(rupperleg, x_axis, rad(20), LEG_SPEED / 1.5)
		Turn(rlowerleg, x_axis, rad(-5), LEG_SPEED)
		Turn(lupperleg, x_axis, rad(-45), LEG_SPEED / 1.5)
