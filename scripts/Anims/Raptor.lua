...
local pelvis, torso, lupperleg, llowerleg, rupperleg, rlowerleg, rfronttoe, lfronttoe, lfoot, rfoot = piece ("pelvis", "torso", "lupperleg", "llowerleg", "rupperleg", "rlowerleg", "rfronttoe", "lfronttoe", "lfoot", "rfoot")
