...
local pelvis, torso, lupperleg, llowerleg, rupperleg, rlowerleg, lfronttoes, rfronttoes = piece ("pelvis", "torso", "lupperleg", "llowerleg", "rupperleg", "rlowerleg", "lfronttoes", "rfronttoes")
...
--		Spring.Echo("anim_Walk")
		...
		Turn(lfronttoes, x_axis, rad(-7.5), LEG_SPEED * speedMod/ 4)
		--Right Leg--
		...
		Turn(lfronttoes, x_axis, rad(-17.5), LEG_SPEED * speedMod/ 4)
		--Right Leg--
		...
		Turn(lfronttoes, x_axis, rad(-20), LEG_SPEED)
		--Right Leg--
		...
		Turn(lfronttoes, x_axis, rad(-10), LEG_SPEED)
		--Right Leg--
		Turn(rupperleg, x_axis, rad(-40), LEG_SPEED)
		Turn(rlowerleg, x_axis, rad(20), LEG_SPEED)
		Turn(rfronttoes, x_axis, rad(7.5), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoes, x_axis)
		...
		Turn(rfronttoes, x_axis, rad(-10), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoes, x_axis)
		...
		Turn(rlowerleg, x_axis, rad(10), LEG_SPEED)
		Turn(rfronttoes, x_axis, rad(-20), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoes, x_axis)
		...
		Turn(lfronttoes, x_axis, rad(7.5), LEG_SPEED)
		--Right Leg--
		Turn(rupperleg, x_axis, rad(10), LEG_SPEED)
