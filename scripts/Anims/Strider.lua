...
local pelvis, torso, lupperleg, llowerleg, rupperleg, rlowerleg, lfronttoe, rfronttoe = piece ("pelvis", "torso", "lupperleg", "llowerleg", "rupperleg", "rlowerleg", "lfronttoe", "rfronttoe")
...
--		Spring.Echo("anim_Turn")
		...
		WaitForTurn(llowerleg, x_axis)
		PlaySound("stomp")
		GG.EmitSfxName(unitID, lfronttoe, "stomp_dust")
		--Right Leg Up...
		Turn(pelvis, z_axis, rad(5), LEG_TURN_SPEED * speedMod/ 2)
		...
		WaitForTurn(rlowerleg, x_axis)
		PlaySound("stomp")
		GG.EmitSfxName(unitID, rfronttoe, "stomp_dust")
	end
end
...
--	Spring.Echo("anim_HalfJump")
		...
		Turn(rlowerleg, x_axis, rad(20), LEG_SPEED * speedMod/ 4)
		Turn(rfronttoe, x_axis, rad(-10), LEG_SPEED * speedMod/ 4)
		Turn(lupperleg, x_axis, rad(-30), LEG_SPEED * speedMod/ 4)
		Turn(llowerleg, x_axis, rad(20), LEG_SPEED * speedMod/ 4)
		Turn(lfronttoe, x_axis, rad(-10), LEG_SPEED * speedMod/ 4)
		--WaitForTurns...
		WaitForTurn(rupperleg, x_axis)
		WaitForTurn(rlowerleg, x_axis)
...
--		Spring.Echo("anim_Walk")
		...
		Turn(lfronttoe, x_axis, rad(-7.5), LEG_SPEED * speedMod/ 4)
		--Right Leg--
		...
		Turn(lfronttoe, x_axis, rad(-17.5), LEG_SPEED * speedMod/ 4)
		--Right Leg--
		...
		Turn(lfronttoe, x_axis, rad(-20), LEG_SPEED)
		--Right Leg--
		...
		Turn(lfronttoe, x_axis, rad(-10), LEG_SPEED)
		--Right Leg--
		Turn(rupperleg, x_axis, rad(-40), LEG_SPEED)
		Turn(rlowerleg, x_axis, rad(20), LEG_SPEED)
		Turn(rfronttoe, x_axis, rad(7.5), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoe, x_axis)
		...
		Turn(rfronttoe, x_axis, rad(-10), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoe, x_axis)
		...
		Turn(rlowerleg, x_axis, rad(10), LEG_SPEED)
		Turn(rfronttoe, x_axis, rad(-20), LEG_SPEED)
		--Wait For Turns...--
		WaitForTurn(lupperleg, x_axis)
		WaitForTurn(llowerleg, x_axis)
		WaitForTurn(lfronttoe, x_axis)
		...
		Turn(lfronttoe, x_axis, rad(7.5), LEG_SPEED)
		--Right Leg--
		Turn(rupperleg, x_axis, rad(10), LEG_SPEED)
