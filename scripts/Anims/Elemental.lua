...
local pelvis, lupperleg, llowerleg, rupperleg, rlowerleg = piece ("pelvis", "lupperleg", "llowerleg", "rupperleg", "rlowerleg")

--Turning/Movement Locals
local LEG_SPEED = rad(1000) * speedMod
local LEG_TURN_SPEED = rad (800) * speedMod
