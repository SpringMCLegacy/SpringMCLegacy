...
local lupperleg, llowerleg, rupperleg, rlowerleg, rfoot, lfoot, lfronttoe, rfronttoe = piece ("lupperleg", "llowerleg", "rupperleg", "rlowerleg", "rfoot", "lfoot", "lfronttoe", "rfronttoe")
...
function script.FireWeapon(weaponID)
		...
		elseif weaponID == 2 then
			EmitSfx(flare2, AC5_MUZZLEFLASH)
